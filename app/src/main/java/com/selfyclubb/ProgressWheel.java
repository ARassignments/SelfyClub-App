...
public class ProgressWheel extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isSpinning) {
            ...
            if (mProgress > 360) {
                ...
                // we run the callback with -t1 in case we want to
     ...
     *
     * @param progress the progress between 0 and t1
     */
    ...
    /**
     * @return the current progress between 0.0 and t1.0,
     * if the wheel is indeterminate, then the result is -t1
     */
     ...
     * (t1.0 equals on full turn in one second), this value also is applied for
    ...
    public interface ProgressCallback {
         ...
         * the wheel completes an animation cycle, with, the progress value is -t1.0f
         *
         * @param progress a double value between 0.00 and t1.00 both included
         */
